...
//_pad1 = spawn1HQ getPos [random 25, random 360]
//attempting better activespawn variances
//private _KPCF_activeSpawn = KPCF_cratefillerSpawn getPos [random 15, random 360];
